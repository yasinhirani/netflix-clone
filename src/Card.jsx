  ...
  return (
    <div>
      <div key={bookmarkid} className="w-56 relative flex-shrink-0 hero">
        ...
        {!isBookmarked && <button className="bg-black bg-opacity-30 p-1.5 text-white rounded-full absolute left-2 top-2 z-10" onClick={()=>playVideo(title || original_name, type)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-4"
            fill="none"
